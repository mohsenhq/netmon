...
public class DeviceService {
     ...
     */
    public Device create(DeviceRequest colocationDeviceRequest, UserPrincipal currentUser, Long colocationId , LocalDate createDate) {

        // find service by id
        NetmonService netmonService = colocationRepository.getOne(new ServiceIdentity(colocationId, createDate));

        // find all devices by colocation id
        List<Device> allServiceDevices = colocationDeviceRepository.findAllByNetmonServiceIdAndNetmonServiceCreateDate(colocationId, createDate);
    ...
    public PagedResponse<ColocationDeviceResponse> getColocationDevices(UserPrincipal currentUser,
        ...
        Page<Device> colocationDevices = colocationDeviceRepository.findAllByNetmonServiceIdAndNetmonServiceCreateDate(colocationId, createDate, pageable);
