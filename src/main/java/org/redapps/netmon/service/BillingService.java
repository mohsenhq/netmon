...
//    }
     ...
     * @return billing response
     */
    public Billing calculateBilling(UserPrincipal currentUser, Long serviceId, LocalDate createDate,
        ...
        if (netmonService.getTerminateDate() != null && netmonService.getTerminateDate().isBefore(endDate))
            endDate = netmonService.getTerminateDate();
        ...
        // Calculate ip usage
        List<IP> ips = serviceIPRepository.findAllByNetmonService(netmonService);
        for (IP ip : ips) {
